...
export const clients: Client[] = [
  {
    ...
    status: "ativo",
    since: "2025-01-15",
    services: ["Tráfego Pago", "Landing Page"],
  },
  {
    id: "c-2",
    name: "Vanessa Lopes",
    company: "Lopes Psicologia",
    plan: "Starter",
    monthlyValue: 3500,
    paymentDay: 10,
  ...
  },
  {
    ...
    status: "ativo",
    since: "2024-11-20",
    services: ["Tráfego Pago", "Automações", "Consultoria"],
  },
  {
    id: "c-4",
    name: "Helena Martins",
    company: "Martins Odontologia",
    plan: "Growth",
    monthlyValue: 7500,
    paymentDay: 20,
    ...
    status: "ativo",
    since: "2025-03-10",
    services: ["Tráfego Pago", "Geração de Demanda"],
  },
  {
    id: "c-5",
    name: "Otávio Freitas",
    company: "Freitas Advocacia",
    plan: "Enterprise",
    monthlyValue: 18500,
    paymentDay: 1,
    ...
    status: "ativo",
    since: "2024-08-01",
    services: ["Tráfego Pago", "Consultoria", "Landing Page", "Automações"],
  },
  {
    id: "c-6",
    name: "Renata Cardoso",
    company: "Cardoso Estética",
    plan: "Starter",
    monthlyValue: 2900,
    paymentDay: 25,
  ...
  },
  {
    ...
    status: "ativo",
    since: "2025-05-08",
    services: ["Tráfego Pago", "Criativos"],
  },
  {
    id: "c-8",
    name: "Camila Reis",
    company: "Reis Nutrição",
    plan: "Starter",
    monthlyValue: 3200,
    paymentDay: 12,
...
export const projects: Project[] = [
  ...
  },
  {
    id: "p-6",
    clientId: "c-4",
    clientName: "Martins Odontologia",
    name: "Criativos Julho",
    type: "Criativos",
    status: "entregue",
    fase: "implementacao",
    progress: 100,
...
export const tasks: Task[] = [
  ...
  {
    id: "t-2",
    title: "Enviar proposta Ribeiro Motors",
    owner: "Rafael Souza",
    priority: "urgente",
    status: "hoje",
    dueDate: "2026-07-03",
  ...
  {
    id: "t-3",
    title: "Revisar criativos Andrade Fitness",
    owner: "Camila Torres",
    priority: "media",
    status: "andamento",
    dueDate: "2026-07-04",
  ...
  {
    id: "t-4",
    title: "Reunião de kickoff Reis Nutrição",
    owner: "Ana Prado",
    priority: "alta",
    status: "hoje",
    dueDate: "2026-07-03",
  ...
  {
    id: "t-5",
    title: "Configurar pixel LP Pereira",
    owner: "Bruno Lima",
    priority: "media",
    status: "andamento",
    dueDate: "2026-07-05",
  ...
  {
    id: "t-6",
    title: "Relatório mensal Barros Seguros",
    owner: "Bruno Lima",
    priority: "alta",
    status: "backlog",
    dueDate: "2026-07-08",
  ...
  {
    id: "t-7",
    title: "Cobrar retorno Fernanda Rocha",
    owner: "Camila Torres",
    priority: "media",
    status: "hoje",
    dueDate: "2026-07-03",
  ...
  {
    id: "t-8",
    title: "Atualizar checklist Freitas",
    owner: "Ana Prado",
    priority: "baixa",
    status: "backlog",
    dueDate: "2026-07-10",
  ...
  {
    id: "t-9",
    title: "Publicar campanha Martins",
    owner: "Camila Torres",
    priority: "urgente",
    status: "concluida",
    dueDate: "2026-07-02",
...
export const agendaEvents: AgendaEvent[] = [
  {
    id: "e-1",
    title: "Reunião kickoff Reis Nutrição",
    type: "reuniao",
    date: "2026-07-03",
    time: "10:00",
    with: "Camila Reis",
  ...
  {
    id: "e-2",
    title: "Follow-up Ribeiro Motors",
    type: "followup",
    date: "2026-07-03",
    time: "14:00",
    with: "Gustavo Ribeiro",
  },
  {
    id: "e-3",
    title: "Pagamento Pereira Ortopedia",
    type: "pagamento",
    date: "2026-07-05",
    time: "09:00",
  },
  ...
  {
    id: "e-5",
    title: "Diagnóstico Fernanda Rocha",
    type: "reuniao",
    date: "2026-07-04",
    time: "16:30",
    with: "Fernanda Rocha",
  ...
  {
    id: "e-7",
    title: "Pagamento Barros Seguros",
    type: "pagamento",
    date: "2026-07-15",
    time: "09:00",
  },
...
export const financeEntries: FinanceEntry[] = [
  {
    id: "f-1",
    date: "2026-07-01",
    description: "Mensalidade Pereira Ortopedia",
    category: "Mensalidade",
    costCenter: "Receita",
    type: "entrada",
    amount: 8500,
    client: "Pereira Ortopedia",
    recurring: true,
  },
  {
    id: "f-2",
    date: "2026-07-01",
    description: "Mensalidade Barros Seguros",
    category: "Mensalidade",
    costCenter: "Receita",
    type: "entrada",
    amount: 12000,
    client: "Barros Seguros",
    recurring: true,
  },
  {
    id: "f-3",
    date: "2026-07-01",
    description: "Mensalidade Freitas Advocacia",
    category: "Mensalidade",
    costCenter: "Receita",
    type: "entrada",
    amount: 18500,
    client: "Freitas Advocacia",
    recurring: true,
  },
  {
    id: "f-4",
    date: "2026-07-01",
    description: "Mensalidade Martins Odontologia",
    category: "Mensalidade",
    costCenter: "Receita",
    type: "entrada",
    amount: 7500,
    client: "Martins Odontologia",
    recurring: true,
  },
  {
    id: "f-5",
    date: "2026-07-02",
    description: "Projeto LP Pereira",
    category: "Projeto",
    costCenter: "Receita",
    type: "entrada",
    amount: 4500,
  ...
  },
  {
    id: "f-7",
    date: "2026-07-03",
    description: "Meta Ads Manager Tools",
    category: "Software",
  ...
  },
  {
    id: "f-10",
    date: "2026-07-05",
    description: "Marketing Institucional",
    category: "Anúncios",
  ...
  },
  {
    id: "f-11",
    date: "2026-06-01",
    description: "Receita Junho (consolidado)",
    category: "Mensalidade",
    costCenter: "Receita",
    type: "entrada",
    amount: 48500,
  ...
  },
  {
    id: "f-12",
    date: "2026-05-01",
    description: "Receita Maio (consolidado)",
    category: "Mensalidade",
    costCenter: "Receita",
    type: "entrada",
    amount: 44200,
...
export const notifications = [
  {
    ...
    description: "Marina Costa não recebe contato há 3 dias",
  ...
  },
  {
    id: "n-2",
    title: "Novo lead",
    description: "Larissa Melo — Clínica Vitalis (Instagram)",
    type: "info" as const,
    time: "4h",
  },
  {
    ...
    description: "Pereira Ortopedia vence em 2 dias",
    type: "warning" as const,
    time: "6h",
  },
  {
    ...
    description: "Ricardo Barros — R$ 12.000/mês",
  ...
  },
  {
    ...
    description: "Vanessa Lopes renova em 30 dias",
    type: "info" as const,
    time: "1d",
  },
];
...
export const automations = [
  {
    id: "a-1",
    name: "Novo Lead → Tarefa de contato",
    trigger: "Lead criado",
    action: "Criar tarefa em 24h para responsável",
    active: true,
    runs: 47,
  },
  {
    id: "a-2",
    name: "Proposta enviada → Follow-up 3 dias",
    trigger: "Card movido para Proposta",
    action: "Agendar follow-up em 3 dias",
    active: true,
    runs: 23,
  },
  {
    id: "a-3",
    name: "Fechado → Onboarding",
    trigger: "Card movido para Fechado",
    action: "Criar cliente + checklist de implantação",
    active: true,
    runs: 8,
  },
  {
    ...
    trigger: "Fatura vencida > 1 dia",
    action: "Notificar financeiro + WhatsApp cliente",
    active: true,
    runs: 3,
  },
  {
    id: "a-5",
    name: "Contrato vence em 30d → Renovação",
    trigger: "Data de renovação em 30 dias",
    action: "Criar tarefa para gestor + email cliente",
    active: false,
    runs: 12,
  },
];
...
export const dashboardKPIs = {
  ...
  leadsNegociacao: leads.filter((l) =>
    ["contato", "diagnostico", "reuniao", "proposta", "negociacao"].includes(l.stage),
  ).length,
  followupsPendentes: 7,
  clientesAtivos: clients.filter((c) => c.status === "ativo").length,
  receitaRecorrente: clients
    .filter((c) => c.status === "ativo")
    .reduce((s, c) => s + c.monthlyValue, 0),
  fluxoCaixa: financeEntries
    .filter((f) => f.date.startsWith("2026-07"))
    .reduce((s, f) => s + (f.type === "entrada" ? f.amount : -f.amount), 0),
};
